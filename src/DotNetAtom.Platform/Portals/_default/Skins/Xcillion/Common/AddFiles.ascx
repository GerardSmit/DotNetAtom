<%@ Register TagPrefix="dnn" Namespace="DotNetAtom.Web.Client.ClientResourceManagement" %>
...
<%-- JS files --%>
<dnn:DnnJsInclude ID="jQuery" runat="server" FilePath="jquery/jquery.min.js" PathNameAlias="SharedScripts" />
