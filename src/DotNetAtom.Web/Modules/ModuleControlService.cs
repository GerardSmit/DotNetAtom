...
public class ModuleControlService : IModuleControlService
{
    ...
    public async Task<Control?> CreateModuleControlAsync(Page page, IPortalSettings settings, IModuleHost moduleHost,
        IModuleInfo module, string? controlKey)
    {
        ...
        if (control is IModuleControl moduleControl)
        {
            ...
            moduleControl.ModuleContext.ModuleHost = moduleHost;
        }
